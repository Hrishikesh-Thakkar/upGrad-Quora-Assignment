...
public class ApiClient {
    ...
    private String basePath = "http://quora.io/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("BearerAuthorization", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://quora.io/api/v1
